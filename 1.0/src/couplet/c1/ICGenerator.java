...
import couplet.c1.ast.ASTNode;
import couplet.c1.ast.ASTScanner;
...
import couplet.c1.ast.ExpressionStatement;
...
import couplet.c1.ic.Label;
import couplet.c1.ic.Location;
import couplet.c1.ic.Mov;
import couplet.c1.ic.Mul;
import couplet.c1.ic.Neg;
import couplet.c1.ic.Operand;
 ...
 * 
 */
public class ICGenerator extends ASTScanner implements couplet.ICGenerator {

	/** 输入的抽象语法树 */
	private couplet.AbstractSyntaxTree ast;
	...
	@Override
	public void setAST(couplet.AbstractSyntaxTree AST) {
		this.ast = AST;
	}
	...
	public void visit(InputStatement node) throws Exception {
		super.visit(node);
		couplet.c1.ast.Location astLocation = node.getLocation();
	...
	@Override
	public void visit(couplet.c1.ast.IntegerLiteral node) throws Exception {
